...
/**
 * Class to compute the CQT and harmonically stack those. Output of this can be
 * given as input to Basic Pitch cnn.
 */
class Features {
public:
  Features();
   ...
   */
  const float *computeFeatures(float *inAudio, size_t inNumSamples,
                               size_t &outNumFrames);
