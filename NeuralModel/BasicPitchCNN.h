...
public:
   ...
   * @param outContours output vector for contour posteriorgrams. Size should be
   * 264
   ...
   */
  void frameInference(const float *inData, std::vector<float> &outContours,
...
private:
  ...
  alignas(RTNEURAL_DEFAULT_ALIGNMENT)
      std::array<float, 33 * NUM_FREQ_OUT> mConcatArray{};
